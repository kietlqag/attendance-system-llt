...
import { LogOut, LayoutDashboard, Calendar, CheckCircle2, Users, Menu, X, UserCog } from 'lucide-react';
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              {sidebarOpen && (
                <div className="min-w-0 flex-1">
                  <h1 className="font-bold text-gray-900 truncate">Quản Trị Điểm Danh</h1>
